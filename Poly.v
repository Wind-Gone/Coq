...
Definition tail  {X : Type}(x : X) (l :list X) : list X :=
    match l with
    | nil => nil
    | cons _ t =>t
    end.
...
Compute [true; false] ++ [false; false].
(* ----------------------------------------------------------------- *)
(** *** Exercises *)
...
Definition filter_even_gt7 (l : list nat) : list nat :=
  filter (fun n => andb (evenb n) (lt_nat 7 n)) l.
...
Proof.
  ...
  -reflexivity.
  -simpl. rewrite <- IHt.  rewrite map_distr. reflexivity. Qed.
